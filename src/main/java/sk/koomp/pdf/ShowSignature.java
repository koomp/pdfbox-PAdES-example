...
import sk.koomp.pdf.cert.CertificateVerifier;
...
public final class ShowSignature
{
                                                     ...
                                                     CertificateVerificationException
    {
        ...
        else
        {
            ...
            RandomAccessRead raFile = new RandomAccessBufferedFileInputStream(infile);
            		// new RandomAccessReadBufferedFile(infile);
    ...
    private void checkContentValueWithFile(File file, int[] byteRange, byte[] contents) throws IOException
    {
    	...
    	// RandomAccessRead raFile = new RandomAccessBufferedFileInputStream(infile); 
        try (RandomAccessRead raf = new RandomAccessBufferedFileInputStream(file))
        {
